...
function printNewBC() {
  ...
  <div class="sub">Boutique Contrées Vertes - Office de Tourisme Tulle Agglo &nbsp;|&nbsp; <em>Non assujetti à la TVA</em></div>
  ...
  <div class="footer">
    ...
    Boutique Contrées Vertes / Office de Tourisme Tulle Agglo &nbsp;|&nbsp;
    contrees-vertes.github.io/COMPTOIR
  </div>
  <script>window.onload=()=>window.print()<\/script>
  </body></html>`);
  win.document.close();
